...
<form method="post" action="<?php echo e(url('update-pegawai', $editMhs->id)); ?>">
    <?php echo e(csrf_field()); ?>

    <div class="row mt-3">
        <div class="col">
        <label for="nama" class="form-label"><h5>Nama Mahasiswa</h5></label>
        <input type="text" class="form-control form-control-lg" placeholder="Nama Lengkap" name="nama" value="<?php echo e($editMhs->nama); ?>">
        </div>
        <div class="col">
        <label for="email" class="form-label"><h5>Alamat Email</h5></label>
        <input type="text" class="form-control form-control-lg" placeholder="Email" name="email" value="<?php echo e($editMhs->email); ?>">
        </div>
    </div>
    <div class="row mt-3">
        <div class="col">
        <label for="nim" class="form-label"><h5>NIM</h5></label>
        <input type="text" class="form-control form-control-lg" placeholder="NIM" id="nim" name="nim" value="<?php echo e($editMhs->nim); ?>">
        </div>
        <div class="col">
        <label for="alamat" class="form-label"><h5>Alamat Rumah</h5></label>
        <input type="text" class="form-control form-control-lg" placeholder="Alamat" name="alamat" value="<?php echo e($editMhs->alamat); ?>">
        </div>
    </div>
    <br>
