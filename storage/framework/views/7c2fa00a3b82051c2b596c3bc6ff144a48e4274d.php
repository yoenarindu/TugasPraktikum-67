            ...
            <div class="course">
              <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col">
                          <a href="<?php echo e(url('edit-mahasiswa', $item->id)); ?>" ><i class="fa-solid fa-pen-to-square"></i></a> 
                          <a href="<?php echo e(url('delete-mahasiswa', $item->id)); ?>" ><i class="fa-solid fa-trash-can" style="color: red;"></i></a>
